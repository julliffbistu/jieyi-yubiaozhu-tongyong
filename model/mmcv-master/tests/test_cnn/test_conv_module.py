...
def test_bias():
    ...
    with pytest.warns(UserWarning) as record:
        ConvModule(3, 8, 2, bias=True, norm_cfg=dict(type='SyncBN'))
    assert len(record) == 1
...
@patch('torch.nn.BatchNorm2d.forward', SyncBN_forward)
