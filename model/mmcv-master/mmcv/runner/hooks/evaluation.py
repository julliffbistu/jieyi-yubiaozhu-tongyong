...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        gpu_collect (bool): Whether to use gpu or cpu to collect results.
            Default: False.
        broadcast_SyncBN_buffer (bool): Whether to broadcast the
    ...
    def __init__(self,
        ...
        self.broadcast_SyncBN_buffer = broadcast_SyncBN_buffer
        self.tmpdir = tmpdir
    ...
    def _do_evaluate(self, runner):
        ...
        if self.broadcast_SyncBN_buffer:
            model = runner.model
