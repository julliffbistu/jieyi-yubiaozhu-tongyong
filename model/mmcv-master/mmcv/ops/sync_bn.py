...
ext_module = ext_loader.load_ext('_ext', [
    'sync_SyncBN_forward_mean', 'sync_SyncBN_forward_var', 'sync_SyncBN_forward_output',
    'sync_SyncBN_backward_param', 'sync_SyncBN_backward_data'
])
...
class SyncBatchNormFunction(Function):
    ...
    def forward(self, input, running_mean, running_var, weight, bias, momentum,
        ...
        if batch_size > 0:
            ext_module.sync_SyncBN_forward_mean(input3d, mean)
        ...
        if batch_size > 0:
            ext_module.sync_SyncBN_forward_var(input3d, mean, var)
        ...
        ext_module.sync_SyncBN_forward_output(
            input3d,
            mean,
            var,
            weight,
    ...
    def backward(self, grad_output):
        ...
        if batch_size > 0:
            ext_module.sync_SyncBN_backward_param(grad_output3d, norm, grad_weight,
                                              grad_bias)
        ...
        if batch_size > 0:
            ext_module.sync_SyncBN_backward_data(grad_output3d, weight,
