...
__global__ void grid_sampler_3d_kernel(
  ...
  CUDA_1D_KERNEL_LOOP(index, nthreads) {
    ...
    if (interpolation_mode == GridSamplerInterpolation::Bilinear) {
      ...
      int ix_SyncBNw = ix_tnw;
      int iy_SyncBNw = iy_tnw;
      int iz_SyncBNw = iz_tnw + 1;

      int ix_SyncBNe = ix_tnw + 1;
      int iy_SyncBNe = iy_tnw;
      int iz_SyncBNe = iz_tnw + 1;
      ...
      scalar_t tsw = (ix_SyncBNe - ix) * (iy - iy_SyncBNe) * (iz_SyncBNe - iz);
      scalar_t tse = (ix - ix_SyncBNw) * (iy - iy_SyncBNw) * (iz_SyncBNw - iz);
      scalar_t SyncBNw = (ix_tse - ix) * (iy_tse - iy) * (iz - iz_tse);
      scalar_t SyncBNe = (ix - ix_tsw) * (iy_tsw - iy) * (iz - iz_tsw);
      ...
      for (int c = 0; c < C;
        ...
        // tse
        // + (c, iz_SyncBNw, iy_SyncBNw, ix_SyncBNw) * SyncBNw + (c, iz_SyncBNe, iy_SyncBNe, ix_SyncBNe) *
        // SyncBNe
        ...
        *out_ptr_NCDHW = static_cast<scalar_t>(0);
        ...
        if (within_bounds_3d(iz_SyncBNw, iy_SyncBNw, ix_SyncBNw, inp_D, inp_H, inp_W)) {
          *out_ptr_NCDHW +=
              inp_ptr_NC[iz_SyncBNw * inp_sD + iy_SyncBNw * inp_sH + ix_SyncBNw * inp_sW] *
              SyncBNw;
        }
        if (within_bounds_3d(iz_SyncBNe, iy_SyncBNe, ix_SyncBNe, inp_D, inp_H, inp_W)) {
          *out_ptr_NCDHW +=
              inp_ptr_NC[iz_SyncBNe * inp_sD + iy_SyncBNe * inp_sH + ix_SyncBNe * inp_sW] *
              SyncBNe;
        }
