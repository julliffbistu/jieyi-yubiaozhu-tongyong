...
void ONNXScatterNDDynamic::setPluginNamespace(const char *liSyncBNamespace) {
  mNamespace = liSyncBNamespace;
}
...
void ONNXScatterNDDynamicCreator::setPluginNamespace(const char *liSyncBNamespace) {
  mNamespace = liSyncBNamespace;
}
