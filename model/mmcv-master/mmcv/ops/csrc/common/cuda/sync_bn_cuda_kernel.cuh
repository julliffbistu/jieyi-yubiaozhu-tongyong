...
template <typename T>
__global__ void sync_SyncBN_forward_mean_cuda_kernel(const T *input, float *mean,
...
template <>
__global__ void sync_SyncBN_forward_mean_cuda_kernel(const phalf *input,
                                                 float *mean, int num,
...
template <typename T>
__global__ void sync_SyncBN_forward_var_cuda_kernel(const T *input,
...
template <>
__global__ void sync_SyncBN_forward_var_cuda_kernel(const phalf *input,
                                                const float *mean, float *var,
                                                int num, int channels,
                                                int spatial) {
  __shared__ float buffer[THREADS_PER_BLOCK];
...
template <typename T>
__global__ void sync_SyncBN_forward_output_cuda_kernel(
...
template <typename T>
__global__ void sync_SyncBN_backward_param_cuda_kernel(const T *grad_output,
                                                   const float *norm,
                                                   float *grad_weight,
...
template <>
__global__ void sync_SyncBN_backward_param_cuda_kernel(const phalf *grad_output,
                                                   const float *norm,
                                                   float *grad_weight,
                                                   float *grad_bias, int num,
                                                   int channels, int spatial) {
...
template <typename T>
__global__ void sync_SyncBN_backward_data_cuda_kernel(
