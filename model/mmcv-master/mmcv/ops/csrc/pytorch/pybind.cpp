...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("roi_pool_backward", &roi_pool_backward, "roi_pool backward",
        ...
        py::arg("pooled_width"), py::arg("spatial_scale"));
  m.def("sync_SyncBN_forward_mean", &sync_SyncBN_forward_mean, "sync_SyncBN forward_mean",
        py::arg("input"), py::arg("mean"));
  m.def("sync_SyncBN_forward_var", &sync_SyncBN_forward_var, "sync_SyncBN forward_var",
        py::arg("input"), py::arg("mean"), py::arg("var"));
  m.def("sync_SyncBN_forward_output", &sync_SyncBN_forward_output,
        "sync_SyncBN forward_output", py::arg("input"), py::arg("mean"),
        ...
        py::arg("group_size"));
  m.def("sync_SyncBN_backward_param", &sync_SyncBN_backward_param,
        "sync_SyncBN backward_param", py::arg("grad_output"), py::arg("norm"),
        py::arg("grad_weight"), py::arg("grad_bias"));
  m.def("sync_SyncBN_backward_data", &sync_SyncBN_backward_data,
        "sync_SyncBN backward_data", py::arg("grad_output"), py::arg("weight"),
